...
public class Test {
	...
	//Twitch
	private static final String URL_TWI_MOBILE		= "https://m.twitch.tv/videos/2309483141";
	private static final String TYPE_TWI_MOBILE 	= "Twitch Mobile (and normal since normal gets converted to mobile)";
	private static final String TTL_TWI_MOBILE 		= "Archipelago Randomizer with @king_yenzala";
	private static final String DATE_TWI_MOBILE 	= "";
	private static final String CHNL_TWI_MOBILE	 	= "ptony on Twitch";
	private static final String TIME_TWI_MOBILE 	= "3:58:26";
